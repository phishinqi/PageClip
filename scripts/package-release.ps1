...
$stage = Join-Path $releaseDir 'PageClip-v1.6.3'
$zip = Join-Path $releaseDir 'PageClip-v1.6.3.zip'
...
if ($manifest.version -ne '1.6.3') { throw "Unexpected manifest version: $($manifest.version)" }
