...
$stage = Join-Path $releaseDir 'PageClip-v1.6.2'
$zip = Join-Path $releaseDir 'PageClip-v1.6.2.zip'
...
if ($manifest.version -ne '1.6.2') { throw "Unexpected manifest version: $($manifest.version)" }
