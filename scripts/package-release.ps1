...
$stage = Join-Path $releaseDir 'PageClip-v1.6.1'
$zip = Join-Path $releaseDir 'PageClip-v1.6.1.zip'
...
if ($manifest.version -ne '1.6.1') { throw "Unexpected manifest version: $($manifest.version)" }
