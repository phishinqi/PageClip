...
$stage = Join-Path $releaseDir 'PageClip-v1.6.4'
$zip = Join-Path $releaseDir 'PageClip-v1.6.4.zip'
...
if ($manifest.version -ne '1.6.4') { throw "Unexpected manifest version: $($manifest.version)" }
