...
const context = {
  ...
  runAutomaticBackup: async () => { automaticBackupCalls++; }, AUTO_BACKUP_ALARM: 'backup', AUTO_BACKUP_DEBOUNCE_MS: 10 * 1000,
...
console.log('Automation controller tests passed: gated bookmark events, removal signal, and change-driven backup debounce');
