...
$zh = Get-Content -LiteralPath (Join-Path $root '_locales/zh_CN/messages.json') -Raw -Encoding UTF8 | ConvertFrom-Json
$en = Get-Content -LiteralPath (Join-Path $root '_locales/en/messages.json') -Raw -Encoding UTF8 | ConvertFrom-Json
